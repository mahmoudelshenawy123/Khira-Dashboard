...
function ItemsTable(props:any) {
    ...
    const {items,deleteItem,pages,currentPage,setCurrentPage,isLoading,isDeleting,cityId}=props
  return (
                    ...
                    <tr key={index}>
                        ...
                        <td>
                            <div className='d-flex gap-4'>
                                ...
                                <Link to={`/apps/neighborhoods/update-neighborhood/${cityId}?squareId=${item.id}`} type='button' className={`btn btn-primary ms-auto `} >
                                    {t('Update')}
                                </Link>

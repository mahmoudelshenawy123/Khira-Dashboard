...
function ItemsTable(props:any) {
  ...
  const {items,services,deleteItem,pages,currentPage,setCurrentPage,isLoading,getData,isDeleting}=props
  return (
                    ...
                    <tr key={index}>
                        ...
                        <td>
                            <div className='d-flex gap-4'>
                                <ItemModal data={item} getData={getData} services={services}/>
